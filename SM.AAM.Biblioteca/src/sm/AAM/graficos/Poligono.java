...
/**
 * Esta clase define un objeto de tipo poligono
 *
 * @author Antonio
 */
public class Poligono extends Forma {
     ...
     */
    public Poligono(Point2D[] puntos) {
     ...
     */
    public Poligono(Point2D punto, Borde borde) {
     ...
     *
     * @param punto - Primer punto del polígono
     * @param relleno - Atributo que se desea asignar a la forma
     */
    public Poligono(Point2D punto, Relleno relleno) {
    ...
    /**
     * Crea un objeto de tipo poligono, pasandole como parámetro un punto, un
     * borde y un Relleno
     *
     * @param punto - Primer punto del polígono
     * @param borde - Borde que se desea asignar a la forma
     * @param relleno - Atributo que se desea asignar a la forma
     */
    public Poligono(Point2D punto, Borde borde, Relleno relleno) {
        this.setAtributo(borde);
        this.setAtributo(relleno);
        geometria = new Polygon();
        geometria.addPoint((int) punto.getX(), (int) punto.getY());
     ...
     */
    public Poligono(Point2D punto, List<Atributo> atributos) {
     ...
     * @param borde - Borde que se desea asignar a la forma
     */
    public Poligono(Point2D[] puntos, Borde borde) {
        this.setAtributo(borde);
        int[] coordenadasX = new int[puntos.length];
        int[] coordenadasY = new int[puntos.length];
        for (int i = 0; i < puntos.length; i++) {
     ...
     */
    public Poligono(Point2D[] puntos, Relleno relleno) {
        this.setAtributo(relleno);
        int[] coordenadasX = new int[puntos.length];
        int[] coordenadasY = new int[puntos.length];
        for (int i = 0; i < puntos.length; i++) {
    ...
    /**
     * Crea un objeto de tipo poligono, pasandole como parámetro un array de
     * puntos, un borde y un relleno
     *
     * @param puntos - Array de puntos
     * @param borde - Borde que se desea asignar a la forma
     * @param relleno - Relleno que se desea asignar a la forma
     */
    public Poligono(Point2D[] puntos, Borde borde, Relleno relleno) {
        this.setAtributo(borde);
        this.setAtributo(relleno);
        int[] coordenadasX = new int[puntos.length];
        int[] coordenadasY = new int[puntos.length];
     ...
     * @param atributos - Atributos que se desea asignar a la forma
     */
    public Poligono(Point2D[] puntos, List<Atributo> atributos) {
        this.setAtributo(atributos);
        int[] coordenadasX = new int[puntos.length];
        int[] coordenadasY = new int[puntos.length];
        for (int i = 0; i < puntos.length; i++) {
